...
void draw(){
  // linkss the value of the speeed variable to the mouse position.
  speed = map(mouseX, 0, width, 0, 50);
  
  background(0);
  // I shift the entire compostion,
  // moving its center from the top let corner to the center of the canvas.
